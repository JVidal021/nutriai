      ...
      <View style={[s.sheet, { height: SHEET_H, paddingBottom: insets.bottom + 4 }]}>
        ...
        <View style={s.header}>
          <View style={s.headerLeft}>
            <Text style={s.tag}>{t('exercise_video.tag' as any)}</Text>
        ...
        <View style={s.webFrame}>
          {loading && (
            <View style={s.loader}>
              ...
              <Text style={s.loaderText}>{t('exercise_video.loading' as any)}</Text>
            </View>
          )}
          <WebView
        ...
        <Text style={s.hint}>{t('exercise_video.hint' as any)}</Text>
      </View>
    </Modal>
  )
}
